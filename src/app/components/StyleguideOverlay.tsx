        ...
        <div className="p-6 sm:p-8 pb-10">
          ...
          <StyleguideSection title="Typography">
            <p className="mt-4 max-w-[80ch] bru-prose-muted">
              Recipes name the roles you pair in UI; scale shows the steps from
              display through body and captions. Keep headings tight and body
              copy within a comfortable measure.
            </p>
            ...
            <StyleguidePanel>
              <div className="grid gap-6">
                <p className="bru-prose-muted max-w-[80ch]">
                  Use a small set of repeatable spacing steps. Panels typically
                  use 20–24px padding; section separators use a thin rule plus a
                  label.
                </p>
          ...
          <StyleguideSection title="Motifs">
            <StyleguidePanel className="py-4 sm:py-5">
              <p className="bru-prose max-w-[80ch]">
                ...
                high contrast neutrals, and crisp physical hover motion. Accent
                red is reserved for interactive states and key hierarchy
                moments.
              </p>
          ...
          <StyleguideSection title="Case study card">
            <p className="mt-4 max-w-[80ch] bru-prose-muted">
              Projects use this panel: eyebrow, title, optional meta line, three
              metadata chips, muted summary, ruled bullet list, CTA row, and an
              optional appendix (for example a screenshot grid).
            </p>
            <CaseStudyCard
              className="mt-6 mb-0"
              ...
              summary={
                <p>
                  Two sentences max: what shipped, for whom, and the constraint
                  that mattered most.
                </p>
              }
              bullets={[
            ...
            <StyleguidePanel className="py-0 px-0">
              <div className="bru-divide-y px-6">
                ...
                <Row
                  ...
                  value={
                    <span>
                      ...
                      descriptions, and overlay helper text use the same direct
                      voice.
                    </span>
                  }
                />
                <Row
                  ...
                  value={
                    <span>
                      ...
                      <span className="text-foreground/90">
                        Technical stack, More background, Exploring, Case study,
                        Section
                      </span>
                      ). Pair with{" "}
                      <code className="font-mono text-[0.8125rem]">Header</code>{" "}
                ...
                <Row
                  ...
                  value={
                    <span>
                      ...
                      <span className="text-foreground/90">Client · year</span>
                ...
                <Row
                  ...
                  value={
                    <span>
                      Bullets are full sentences: lead with a capital, end with
                      a period. Highlights rows keep the same rhythm as
                      case-study bullets.
                    </span>
                  }
                />
                <Row
                  ...
                  value={
                    <span>
                      ...
                      . Prefer action over clever label copy on primary buttons.
                    </span>
                  }
                />
                <Row
                  ...
                  value={
                    <span>
                      ...
                      ). Years in experience rails are plain numerals; highlight
                      counts use two-digit padding in rails.
                    </span>
                  }
                />
                <Row
                  ...
                  value={
                    <span>
                      Hype stacks, exclamation marks in primary chrome, emoji in
                      navigation or section titles, vague superlatives without a
                      concrete claim, and résumé boilerplate (
                      <span className="text-foreground/90">
                        leveraging, utilised, demonstrates strong, best-in-class
                      </span>
                      ).
                    </span>
                  }
          ...
          <StyleguideSection title="Section break patterns">
            <StyleguidePanel>
              <p className="bru-prose-muted max-w-[80ch]">
                Use these as modular layers in the divider spacer. The live site
                spacer is offset for the fixed sidebar; styleguide previews use
                the{" "}
                <span className="text-foreground font-medium">styleguide</span>{" "}
                  ...
                  <Accordion
                    ...
                    header={
                      <div className="grid gap-1">
                        ...
                        <div className="bru-acc-title">Expand for details</div>
          ...
          <StyleguideSection title="Sidebar navigation (NavItem)">
            <p className="mt-4 max-w-[80ch] bru-prose-muted">
              Primary nav uses{" "}
              <span className="text-foreground font-medium">NavItem</span> with{" "}
              <code className="font-mono text-[0.8125rem]">aria-current</code>{" "}
              when active, rail colour transition, and smooth in-page scroll to
              section ids.
            </p>
          ...
          <StyleguideSection title="Theme toggle (DarkModeToggle)">
            <p className="mt-4 max-w-[80ch] bru-prose-muted">
              ...
              <code className="font-mono text-[0.8125rem]">dark</code> class on{" "}
              <code className="font-mono text-[0.8125rem]">
          ...
          <StyleguideSection title="Markdown body">
            <p className="mt-4 max-w-[80ch] bru-prose-muted">
              ...
              body, <code className="font-mono text-[0.8125rem]">bru-link</code>{" "}
          ...
          <StyleguideSection title="Flowchart">
            <p className="mt-4 max-w-[80ch] bru-prose-muted">
              <span className="text-foreground font-medium">Flowchart</span> is
              the shared ruled diagram: header band, responsive step grid,
              optional summary row, and props for steps, labels, column layout,
              and connector glyph.{" "}
              <span className="text-foreground font-medium">
                AiLoopFlowchart
              </span>{" "}
              is a thin preset for the plan → execute → test → refine loop used
              in Journey content.
            </p>
            <div className="mt-4 grid gap-6">
              ...
              <StyleguidePanel>
                <p className="m-0 mb-4 bru-prose-muted max-w-[80ch]">
                  ...
                  <code className="font-mono text-[0.8125rem]">steps</code> and
                  no loop row:
                </p>
                <Flowchart
                  title="Hand-off"
          ...
          <StyleguideSection title="Segmented tabs (Journey overlay)">
            <StyleguidePanel className="mt-4">
              <p className="m-0 bru-prose-muted max-w-[80ch]">
                ...
                default recipe (
                <code className="font-mono text-[0.8125rem]">aria-pressed</code>
            ...
            <StyleguidePanel className="mt-4">
              ...
              <ul className="mt-4 list-none p-0 m-0 border border-rulesolid bg-background/55 shadow-rule max-w-xl">
                {[
                  ...
                  >
                    <div className="bru-label text-foreground/70">{row.k}</div>
