...
export default function Home() {
  ...
  const sections: SectionItem[] = [
    ...
    { title: "Certifications", Component: Certifications, href: "/certifications" },
  ];
  ...
  return (
    <main className="no-scrollbar">
      ...
      {sections.map(({ Component, href, title, showTitle }, idx) => (
        <Section key={href} data={formatIndex(idx)} href={href} title={showTitle !== false ? title : undefined}>
          <Component />
        </Section>
      ))}
    </main>
